...
@section('content')
    ...
    <hr>
        <div class="block mt-2 py-2">
            <h1><span class="text-gray-500">Data szkolenia: </span>{{$certificate->training_date}} </h1>
        </div>

        <div class="block mt-2 py-2">
            <h1><span class="text-gray-500">Szkolenie wygasa:</span> {{$certificate->expiry_date}} </h1>
        </div>
{{--    <div>--}}
