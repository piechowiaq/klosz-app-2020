...
<div class="md:w-1/6 text-center md:text-left ">
    <div class="mb-4">
        <h1 class="text-xs text-indigo-500 font-semibold">{{$company->getName()}}</h1>
    </div>
    ...
    <ul class="">
        <li class="md:mr-6 mt-6">
            <a class="text-indigo-500 hover:text-indigo-800"
               href="{{ route('user.dashboard', ['company'=>$company ?? 'company']) }}">
                <svg class=" hidden md:inline-block  mr-4  " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                     width="24" height="24">
                    <path
        ...
        <li class="md:mr-6 mt-6">
            <a class="text-indigo-500 hover:text-indigo-800"
               href="{{ route('user.registries.index', ['company'=>$company ?? 'company'] ) }}">
                <svg class="hidden md:inline-block  mr-4 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                     width="24" height="24">
                    <path
        ...
        <li class="md:mr-6 mt-6">
            <a class="text-indigo-500 hover:text-indigo-800"
               href="{{ route('user.trainings.index', ['company'=>$company ?? 'company'] ) }}">
                <svg class="hidden md:inline-block mr-4 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                     width="24" height="24">
        ...
        <li class="md:mr-6 mt-6">
            <a class="text-indigo-500 hover:text-indigo-800"
               href="{{ route('user.employees.index', ['company'=>$company ?? 'company'] ) }}">
                <svg class="hidden md:inline-block mr-4 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                     width="24" height="24">
                    <path class="heroicon-ui"
        ...
        @can('view', $user)
            <li class="md:mr-6 mt-6">
                <a class="text-indigo-500 hover:text-indigo-800" href="{{ route('user.home') }}">
                    <svg class="hidden md:inline-block mr-4 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                         width="24" height="24">
                        <path
